				...
				<div id="container">
					...
					<div id="head4">
						...
						<input type="button" class="hd4"
							style="background-color: white; border: none; margin-right: 5px;"
							value="♥관심회원 등록하기">
					...
					<form action="/add.reply?parent_seq=${dto.seq}$writer=${loginID}"
						method="post">
					...
					<c:forEach var="i" items="${reply}">
						...
						<form action="modify.reply?pseq=${dto.seq}&seq=${i.replySeq}"
							method="post" id="modifyFrm">

							<div class="reply_view">${loginID}| ${dto.wirteDate}</div>

							<div class="head6">
								<div class="reply_contents">${i.contents}</div>
