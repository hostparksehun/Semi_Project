...
<body>
  <div class="container">
    ...
    <!----------------------------------- MD의 추천 ----------------------------------->
    <div class="col-12 d-none d-lg-block banner">
      <p class="m-auto banner_top">오늘은 이 술 어떠신가요?</p>
    </div>
    
     <div class="col-12 d-lg-none banner">
      <p class="m-auto banner_top">오늘의 술</p>
    </div>

    <div class="row m-auto best_box px-4 my-4">

      <div class="col-12 col-lg-4 Result_box mt-4 my-lg-5">
        <a href="/Detail.ProductController?seq=11">
          <div class="Result_img mb-2">
            <img src="../thumbnail/bori17.png" class="w-100" style="border-radius: 5px;">
          </div>
          <div class="Result_txt" style="text-align: center;">
            ...
            <p class="Result_name my-0">황금보리소주 17</p>
            <p class="Result_price my-1">
              ₩34,000
            </p>
            <p class="Result_decs mb-4 mb-lg-0">은은한 보리향이 일품</p>
          </div>
        </a>
      </div>

      <div class="col-12 col-lg-4 Result_box mt-4 my-lg-5">
        <a href="/Detail.ProductController?seq=106">
          <div class="Result_img mb-2">
            <img src="../thumbnail/sinabro.png" class="w-100" style="border-radius: 5px;">
          </div>
          <div class="Result_txt" style="text-align: center;">
            <div class="row Result_grade">
              <div class="col-6 px-0" style="text-align: right;">
            ...
            <p class="Result_name my-0">시나브로 에뚜왈</p>
            <p class="Result_price my-1">
              ₩30,000
            </p>
            <p class="Result_decs mb-4 mb-lg-0">빛나는 스파클링의 매력</p>
          </div>
        </a>
      </div>
      
       <div class="col-12 col-lg-4 Result_box mt-4 my-lg-5">
        <a href="/Detail.ProductController?seq=18">
          <div class="Result_img mb-2">
            <img src="../thumbnail/cloud.png" class="w-100" style="border-radius: 5px;">
          </div>
          <div class="Result_txt" style="text-align: center;">
            <div class="row Result_grade">
              <div class="col-6 px-0" style="text-align: right;">
            ...
            <p class="Result_name my-0">구름을 벗삼아</p>
            <p class="Result_price my-1">
              ₩20,000
            </p>
            <p class="Result_decs mb-4 mb-lg-0">여유와 휴식을 권하는 탁주</p>
          </div>
        </a>
      </div>
    ...
    <div class="col-12 mt-4" id="navmenu">
      <nav class="nav nav-pills nav-fill">
        <a class="nav-link categor_list_btn mx-2 my-2 my-lg-0" href="#"
          style="background-color:#2c6246; color:white;">전체 상품</a>
        <a class="nav-link categor_list_btn mx-2 my-2 my-lg-0" href="/productA10.ProductController?cpage=1">막걸리</a>
        <a class="nav-link categor_list_btn mx-2 my-2 my-lg-0" href="/productA20.ProductController?cpage=1">전통소주</a>
