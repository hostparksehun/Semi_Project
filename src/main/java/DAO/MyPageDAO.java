...
public class MyPageDAO {
	...
	//---------------게시글 모아보기---------------------------------
	private int getRecordTotalCount( String where) throws Exception{
	...
	// Page Navigator
		public String getPageNavi(int currentPage, int type, String where, int selectType, String search) throws Exception{
			int recordTotalCount = this.getRecordTotalCount(where);	// 총 게시글의 개수 -> 향후 실제 데이터베이스의 개수를 세어와야함
